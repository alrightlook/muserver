...
import muserver.cs.configs.AppenderConfigs;
import muserver.cs.configs.CommonConfigs;
import muserver.cs.configs.ServerListConfigs;
import muserver.cs.exceptions.ConnectServerException;
import muserver.cs.intializers.TcpConnectServerInitializer;
import muserver.cs.intializers.UdpConnectServerInitializer;
...
public class ConnectServer {
 ...
 private void updateLoggerConfiguration(CommonConfigs commonConfigs) throws ConnectServerException {
   ...
   switch (appender.type()) {
    ...
    case ROLLING_FILE: {
     ...
     if (triggeringPolicy == null) {
      throw new ConnectServerException("Triggering policy is null or not valid");
     }
