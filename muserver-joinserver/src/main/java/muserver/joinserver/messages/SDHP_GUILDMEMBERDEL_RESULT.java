...
@AutoValue
public abstract class SDHP_GUILDMEMBERDEL_RESULT extends AbstractPacket<SDHP_GUILDMEMBERDEL_RESULT> {
 public static Builder builder() {
  return new AutoValue_SDHP_GUILDMEMBERDEL_RESULT.Builder();
 }

 public static SDHP_GUILDMEMBERDEL_RESULT create(PBMSG_HEAD header, Byte result, Byte flag, Short number, String guildName, String memberId) {
  return builder()
      .header(header)
      .result(result)
      .flag(flag)
 ...
 public static SDHP_GUILDMEMBERDEL_RESULT deserialize(ByteArrayInputStream stream) throws IOException {
  PBMSG_HEAD header = PBMSG_HEAD.deserialize(stream);

  return SDHP_GUILDMEMBERDEL_RESULT.create(
      header,
      readByte(stream),
      readByte(stream),
      readShortBE(stream),
 ...
 public abstract static class Builder {
  ...
  public abstract SDHP_GUILDMEMBERDEL_RESULT build();
 }
}
