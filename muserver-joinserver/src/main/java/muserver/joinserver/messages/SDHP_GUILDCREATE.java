...
@AutoValue
public abstract class SDHP_GUILDCREATE extends AbstractPacket<SDHP_GUILDCREATE> {
    public static Builder builder() {
        return new AutoValue_SDHP_GUILDCREATE.Builder();
    }

    public static SDHP_GUILDCREATE create(PBMSG_HEAD header, Short number, String guildName, String master, byte[] mark, Integer score) {
        return builder()
                .header(header)
                .number(number)
                .guildName(guildName)
    ...
    public static SDHP_GUILDCREATE deserialize(ByteArrayInputStream stream) throws IOException {
        PBMSG_HEAD header = PBMSG_HEAD.deserialize(stream);

        return SDHP_GUILDCREATE.create(
                header,
                readShortBE(stream),
    ...
    public abstract static class Builder {
        ...
        public abstract SDHP_GUILDCREATE build();
    }
}
