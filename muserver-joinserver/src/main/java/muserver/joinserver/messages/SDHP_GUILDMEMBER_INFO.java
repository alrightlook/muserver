...
@AutoValue
public abstract class SDHP_GUILDMEMBER_INFO extends AbstractPacket<SDHP_GUILDMEMBER_INFO> {
 public static Builder builder() {
  return new AutoValue_SDHP_GUILDMEMBER_INFO.Builder();
 }

 public static SDHP_GUILDMEMBER_INFO create(PBMSG_HEAD header, String guildName, String memberId) {
  return builder()
      .header(header)
      .guildName(guildName)
      .memberId(memberId)
 ...
 public static SDHP_GUILDMEMBER_INFO deserialize(ByteArrayInputStream stream) throws IOException {
  PBMSG_HEAD header = PBMSG_HEAD.deserialize(stream);

  return SDHP_GUILDMEMBER_INFO.create(
      header,
 ...
 public abstract static class Builder {
  ...
  public abstract SDHP_GUILDMEMBER_INFO build();
 }
}
