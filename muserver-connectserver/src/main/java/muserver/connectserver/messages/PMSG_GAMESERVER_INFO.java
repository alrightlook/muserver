...
public abstract class PMSG_GAMESERVER_INFO extends AbstractPacket<PMSG_GAMESERVER_INFO> {
 ...
 public static PMSG_GAMESERVER_INFO create(PBMSG_HEAD header, short serverCode, byte percent, short userCount, short accountCount, short pcBangCount, short maxUserCount) {
  return builder()
      .header(header)
